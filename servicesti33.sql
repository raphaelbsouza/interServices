...
CREATE TABLE `tbcliente` (
  ...
  `ENDERECO` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TELEFONE` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `tbcliente` VALUES (1,'JOSE DA SILVA XAVIER','RUA DAS MAMONAS n 83','84983818181'),(2,'JOSE SILVA','FERREIRA RUA ','841912938338'),(3,'ze','ze','1233123123123'),(4,'LEANDRO SALGADO','RUA PRAIA DE PONTA NEGRA','RUA PRAIA DE PONTA NEGRA'),(5,'LEANDRO AUGUSTOOOOOOOOOO','RUA PRAIA PONTA NEGAR','(84)9,8899-8181'),(6,'PYTHON ','RUA DO PYTHON','(84)9,9998-8181');
...
CREATE TABLE `tbfuncionarios` (
  ...
  `TELEFONE` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `FUNCAO` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `tbservicos` (
  ...
  `TELEFONE` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ATENDENTE` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SERVICO` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DATA` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `HORA` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
-- Dump completed on 2021-02-02  0:50:18
